...
local COUNTRIES = {
        ...
        addCountry { id = "SouthAfrica", name = "South Africa", code = "ZA-710", filename = "SouthAfrica.lua", continent = "Africa",        admin_label = "Provinces & Areas",  mountain_max = 3482, data = southAfricaData, remoteIslandNames = { "Bird Island", "Dassen Island", "Malgas Island", "Marion Island", "Prince Edward Island", "Robben Island", "St Croix Island" } },
